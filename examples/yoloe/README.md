...
**Setup Instructions:**
1. Download the `labels.txt` file from the link above.
2. Place the downloaded file into the `input/` directory of your project (or your preferred folder).
...
The executable will be generated at `build/linux/64/yoloe_demo` (or `build/linux/32/yoloe_demo`).
