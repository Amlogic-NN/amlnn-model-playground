...
def main():
    ...
    parser.add_argument("--backbone-model", required=True, help="Path to the four-output DINOv2 depth backbone .adla")
    parser.add_argument("--depth-model", required=True, help="Path to the single-input DINOv2 depth head .adla")
    ...
    depth_model.load_model(path=args.depth_model)
