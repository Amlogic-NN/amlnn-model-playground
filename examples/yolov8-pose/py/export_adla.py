...
def main():
    ...
    amlnn.load_onnx(
        model=args.onnx,
        outputs=[
        "/model.22/Mul_2_output_0",     # <-- bbox coord (1x4x8400 grid)
        "/model.22/Sigmoid_output_0",   # <-- bbox score (1x1x8400 grid)
        "/model.22/Sigmoid_1_output_0", # <-- pose keypoint score (1x17x1x8400 grid)
        "/model.22/Mul_4_output_0"      # <-- pose keypoint corod (1x17x2x8400 grid) 
    ])
