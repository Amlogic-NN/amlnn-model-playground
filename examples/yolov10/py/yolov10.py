...
def postprocess(outputs, scale, pad, class_names, conf_threshold=0.25, iou_threshold=0.45):
    ...
    for s_idx in range(3):
        ...
        # 16-Bin DFL Decode (64 channels / 4 = 16 bins)
...
def main():
    ...
    parser.add_argument('--classes-path', default="../input/coco_80_names.txt", help='Path to classes txt file')
    ...
    amlnn.load_onnx(
        ...
        outputs=[
            "/model.23/Reshape_3_output_0", "/model.23/Reshape_output_0",
            "/model.23/Reshape_4_output_0", "/model.23/Reshape_1_output_0",
            "/model.23/Reshape_5_output_0", "/model.23/Reshape_2_output_0"
        ]
    )
