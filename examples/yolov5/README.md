...
The executable will be generated at `build/android/yolov5_demo` (Note: executable name may vary, verify in build folder).
...
adb push build/android/yolov5_demo /data/local/tmp/
adb push ../model/yolov5_w8a8.adla /data/local/tmp/
...
./yolov5_demo yolov5_w8a8.adla input/
```

**Note:** Replace `yolov5_w8a8.adla` with your actual model file path.
...
The executable will be generated at `build/linux/64/yolov5_demo` (or `build/linux/32/yolov5_demo`).
...
The executable will be generated at `build/yocto/64/yolov5_demo` (or `build/yocto/32/yolov5_demo`).
...
adb shell "mkdir -p /data/local/tmp/" 
adb push build/linux/yolov5_demo /data/local/tmp/
adb push ../model/yolov5_w8a8.adla /data/local/tmp/
adb push ../input/ /data/local/tmp/
...
**Note:** Replace `yolov5_w8a8.adla` with your actual model file name.
