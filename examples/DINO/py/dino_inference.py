...
def main():
    ...
    parser.add_argument("--backbone", required=True, help="Path to DINO backbone .adla model")
    parser.add_argument("--classifier", required=True, help="Path to DINO classifier .adla model")
