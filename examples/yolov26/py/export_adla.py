...
def main():
    ...
    amlnn.load_onnx(
        ...
        outputs=[
            "/model.23/one2one_cv3.0/one2one_cv3.0.2/Conv_output_0",   # <-- 1x80x80x80 (Stride 8 cls)
            "/model.23/one2one_cv2.0/one2one_cv2.0.2/Conv_output_0",   # <-- 1x4x80x80 (Stride 8 dfl)
            "/model.23/one2one_cv3.1/one2one_cv3.1.2/Conv_output_0",   # <-- 1x80x40x40 (Stride 16 cls)
            "/model.23/one2one_cv2.1/one2one_cv2.1.2/Conv_output_0",   # <-- 1x4x40x40 (Stride 16 dfl)
            "/model.23/one2one_cv3.2/one2one_cv3.2.2/Conv_output_0",   # <-- 1x80x20x20 (Stride 32 cls)
            "/model.23/one2one_cv2.2/one2one_cv2.2.2/Conv_output_0"    # <-- 1x4x20x20 (Stride 32 dfl)
        ]
    )
