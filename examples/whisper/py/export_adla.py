...
def main():
    ...
    parser.add_argument("--encoder-onnx", required=True, help="Path to Encoder ONNX model")
    parser.add_argument("--decoder-onnx", required=True, help="Path to Decoder ONNX model")
    ...
    encoder_model_path = Path(args.encoder_onnx).resolve()
    decoder_model_path = Path(args.decoder_onnx).resolve()
    ...
    amlnn.load_onnx(model=str(encoder_model_path), outputs=["encoder_hidden_states"])
    ...
    amlnn.load_onnx(model=str(decoder_model_path), outputs=["logits"])
