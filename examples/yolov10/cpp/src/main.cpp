...
int main(int argc, char **argv)
{
    ...
    std::cout << "YOLOv10 Demo" << std::endl;
    fs::create_directory("yolov10_result");
    ...
    {
        std::cerr << "Expected 6 YOLOv10 outputs, but model has "
    ...
    for (auto &it : fs::directory_iterator(argv[2]))
    {
        ...
        std::string out_path = "yolov10_result/" + it.path().filename().string();
