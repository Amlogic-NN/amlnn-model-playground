...
This example runs YOLOV8-SEG with AMLNN. The full flow is:
...
The executable will be generated at `build/android/yolov8_seg_demo` (Note: executable name may vary, verify in build folder).
...
adb push build/android/yolov8_seg_demo /data/local/tmp/
adb push ../model/yolov8_seg_w8a8.adla /data/local/tmp/
...
./yolov8_seg_demo yolov8_seg_w8a8.adla input/
```

**Note:** Replace `yolov8_seg_w8a8.adla` with your actual model file path.
...
The executable will be generated at `build/yocto/64/yolov8_seg_demo` (or `build/yocto/32/yolov8_seg_demo`).
...
adb shell "mkdir -p /data/local/tmp/" 
adb push build/linux/yolov8_seg_demo /data/local/tmp/
adb push ../model/yolov8_seg_w8a8.adla /data/local/tmp/
adb push ../input/ /data/local/tmp/
...
**Note:** Replace `yolov8_seg_w8a8.adla` with your actual model file name.
