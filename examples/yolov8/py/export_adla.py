...
def main():
    ...
    amlnn.load_onnx(
        ...
        outputs=[
        "/model.22/cv3.0/cv3.0.2/Conv_output_0",   # <-- 1x80x80x80 (Stride 8 cls)
        "/model.22/cv2.0/cv2.0.2/Conv_output_0",   # <-- 1x64x80x80 (Stride 8 dfl)
        "/model.22/cv3.1/cv3.1.2/Conv_output_0",   # <-- 1x80x40x40 (Stride 16 cls)
        "/model.22/cv2.1/cv2.1.2/Conv_output_0",   # <-- 1x64x40x40 (Stride 16 dfl)
        "/model.22/cv3.2/cv3.2.2/Conv_output_0",   # <-- 1x80x20x20 (Stride 32 cls)
        "/model.22/cv2.2/cv2.2.2/Conv_output_0"    # <-- 1x64x20x20 (Stride 32 dfl)
        ]
    )
