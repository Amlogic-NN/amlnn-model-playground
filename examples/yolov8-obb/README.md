...
The executable will be generated at `build/android/yolov8_obb_demo` (Note: executable name may vary, verify in build folder).
...
adb push build/android/yolov8_obb_demo /data/local/tmp/
adb push ../model/yolov8_obb_w8a8.adla /data/local/tmp/
...
./yolov8_obb_demo yolov8_obb_w8a8.adla input/
```

**Note:** Replace `yolov8_obb_w8a8.adla` with your actual model file path.
...
The executable will be generated at `build/linux/64/yolov8_obb_demo` (or `build/linux/32/yolov8_obb_demo`).
...
The executable will be generated at `build/yocto/64/yolov8_obb_demo` (or `build/yocto/32/yolov8_obb_demo`).
...
adb shell "mkdir -p /data/local/tmp/" 
adb push build/linux/yolov8_obb_demo /data/local/tmp/
adb push ../model/yolov8_obb_w8a8.adla /data/local/tmp/
adb push ../input/ /data/local/tmp/
...
**Note:** Replace `yolov8_obb_w8a8.adla` with your actual model file name.
