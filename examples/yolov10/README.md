...
The executable will be generated at `build/android/yolov10_demo` (Note: executable name may vary, verify in build folder).
...
adb push build/android/yolov10_demo /data/local/tmp/
adb push ../model/yolov10_w8a8.adla /data/local/tmp/
...
./yolov10_demo yolov10_w8a8.adla input/
```

**Note:** Replace `yolov10_w8a8.adla` with your actual model file path.
...
The executable will be generated at `build/linux/64/yolov10_demo` (or `build/linux/32/yolov10_demo`).
...
The executable will be generated at `build/yocto/64/yolov10_demo` (or `build/yocto/32/yolov10_demo`).
...
adb shell "mkdir -p /data/local/tmp/" 
adb push build/linux/yolov10_demo /data/local/tmp/
adb push ../model/yolov10_w8a8.adla /data/local/tmp/
adb push ../input/ /data/local/tmp/
...
**Note:** Replace `yolov10_w8a8.adla` with your actual model file name.
