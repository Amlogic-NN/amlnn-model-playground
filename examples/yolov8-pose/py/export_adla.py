...
def main():
    ...
    amlnn.load_onnx(
        ...
        outputs=[
            "/model.22/Concat_1_output_0",               # <-- Stride 8 dfl + conf score (1x65x80x80)
            "/model.22/cv4.0/cv4.0.2/Conv_output_0",     # <-- Stride 8 pose keypoints + pose conf (1x51x80x80)
            "/model.22/Concat_2_output_0",               # <-- Stride 16 dfl + conf score (1x65x40x40)
            "/model.22/cv4.1/cv4.1.2/Conv_output_0",     # <-- Stride 16 pose keypoints + pose conf (1x51x40x40)
            "/model.22/Concat_3_output_0",               # <-- Stride 32 dfl + conf score (1x65x20x20)
            "/model.22/cv4.2/cv4.2.2/Conv_output_0"      # <-- Stride 32 pose keypoints + pose conf (1x51x20x20)
        ]
    )
