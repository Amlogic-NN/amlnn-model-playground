...
The executable will be generated at `build/android/yolov26_demo` (Note: executable name may vary, verify in build folder).
...
adb push build/android/yolov26_demo /data/local/tmp/
adb push ../model/yolov26_w8a8.adla /data/local/tmp/
...
./yolov26_demo yolov26_w8a8.adla input/
```

**Note:** Replace `yolov26_w8a8.adla` with your actual model file path.
...
The executable will be generated at `build/linux/64/yolov26_demo` (or `build/linux/32/yolov26_demo`).
...
The executable will be generated at `build/yocto/64/yolov26_demo` (or `build/yocto/32/yolov26_demo`).
...
adb shell "mkdir -p /data/local/tmp/"
adb push build/linux/yolov26_demo /data/local/tmp/
adb push ../model/yolov26_w8a8.adla /data/local/tmp/
adb push ../input/ /data/local/tmp/
...
**Note:** Replace `yolov26_w8a8.adla` with your actual model file name.
