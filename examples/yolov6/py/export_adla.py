...
def main():
    ...
    amlnn.load_onnx(
        ...
        outputs=[
            "onnx::Sigmoid_354",  # <-- 1x80x80x80 (Stride 8 cls)
            "onnx::Concat_377",   # <-- 1x4x6400 (Stride 8 dfl)
            "onnx::Sigmoid_386",  # <-- 1x80x40x40 (Stride 16 cls)
            "onnx::Concat_409",   # <-- 1x4x1600 (Stride 16 dfl)
            "onnx::Sigmoid_418",  # <-- 1x80x20x20 (Stride 32 cls)
            "onnx::Concat_441"    # <-- 1x4x400 (Stride 32 dfl)
        ]
    )
