...
def main():
    ...
    amlnn.load_onnx(
        ...
        outputs=[
            "/model.22/cv2.0/cv2.0.2/Conv_output_0",    # <-- Stride 8 dfl (1x64x80x80 grid)
            "/model.22/cv3.0/cv3.0.2/Conv_output_0",    # <-- Stride 8 cls (1x80x80x80 grid)
            "/model.22/cv4.0/cv4.0.2/Conv_output_0",    # <-- Stride 8 mask coeff (1x32x80x80 grid)
            "/model.22/cv2.1/cv2.1.2/Conv_output_0",    # <-- Stride 16 dfl (1x64x40x40 grid)
            "/model.22/cv3.1/cv3.1.2/Conv_output_0",    # <-- Stride 16 cls (1x80x40x40 grid)
            "/model.22/cv4.1/cv4.1.2/Conv_output_0",    # <-- Stride 16 mask coeff (1x32x40x40 grid)
            "/model.22/cv2.2/cv2.2.2/Conv_output_0",    # <-- Stride 32 dfl (1x64x20x20 grid)
            "/model.22/cv3.2/cv3.2.2/Conv_output_0",    # <-- Stride 32 cls (1x80x20x20 grid)
            "/model.22/cv4.2/cv4.2.2/Conv_output_0",    # <-- Stride 32 mask coeff (1x32x20x20 grid)
            "output1"                                   # <-- prototype mask (1x32x160x160 grid)
        ]
    )
