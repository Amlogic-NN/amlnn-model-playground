...
The executable will be generated at `build/android/yoloworld_demo` (Note: executable name may vary, verify in build folder).
...
adb push build/android/yoloworld_demo /data/local/tmp/
adb push ../model/yoloworld_w8a8.adla /data/local/tmp/
...
./yoloworld_demo yoloworld_w8a8.adla input/
```

**Note:** Replace `yoloworld_w8a8.adla` with your actual model file path.
...
The executable will be generated at `build/linux/64/yoloworld_demo` (or `build/linux/32/yoloworld_demo`).
...
The executable will be generated at `build/yocto/64/yoloworld_demo` (or `build/yocto/32/yoloworld_demo`).
...
adb shell "mkdir -p /data/local/tmp/" 
adb push build/linux/yoloworld_demo /data/local/tmp/
adb push ../model/yoloworld_w8a8.adla /data/local/tmp/
adb push ../input/ /data/local/tmp/
...
**Note:** Replace `yoloworld_w8a8.adla` with your actual model file name.
