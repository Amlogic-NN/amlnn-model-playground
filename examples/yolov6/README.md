...
| `--conf` | (Optional) Confidence Threshold, default to 0.5  |
...
The executable will be generated at `build/android/yolov6_demo` (Note: executable name may vary, verify in build folder).
...
adb push build/android/yolov6_demo /data/local/tmp/
adb push ../model/yolov6_w8a8.adla /data/local/tmp/
...
./yolov6_demo yolov6_w8a8.adla input/
```

**Note:** Replace `yolov6_w8a8.adla` with your actual model file path.
...
The executable will be generated at `build/linux/64/yolov6_demo` (or `build/linux/32/yolov6_demo`).
...
The executable will be generated at `build/yocto/64/yolov6_demo` (or `build/yocto/32/yolov6_demo`).
...
adb shell "mkdir -p /data/local/tmp/" 
adb push build/linux/yolov6_demo /data/local/tmp/
adb push ../model/yolov6_w8a8.adla /data/local/tmp/
adb push ../input/ /data/local/tmp/
...
**Note:** Replace `yolov6_w8a8.adla` with your actual model file name.
