...
The executable will be generated at `build/android/ppyoloe_demo` (Note: executable name may vary, verify in build folder).
...
adb push build/android/ppyoloe_demo /data/local/tmp/
adb push ../model/ppyoloe_w8a8.adla /data/local/tmp/
...
./ppyoloe_demo ppyoloe_w8a8.adla input/
```

**Note:** Replace `ppyoloe_w8a8.adla` with your actual model file path.
...
The executable will be generated at `build/linux/64/ppyoloe_demo` (or `build/linux/32/ppyoloe_demo`).
...
The executable will be generated at `build/yocto/64/ppyoloe_demo` (or `build/yocto/32/ppyoloe_demo`).
...
adb shell "mkdir -p /data/local/tmp/" 
adb push build/linux/ppyoloe_demo /data/local/tmp/
adb push ../model/ppyoloe_w8a8.adla /data/local/tmp/
adb push ../input /data/local/tmp/
...
./ppyoloe_demo ppyoloe_w8a8.adla input/ input/labels.txt
```
**Note:** Replace `ppyoloe_w8a8.adla` with your actual model file name.
