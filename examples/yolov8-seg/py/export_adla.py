...
def main():
    ...
    amlnn.load_onnx(
        model=args.onnx,
        outputs=[
        "/model.22/Mul_2_output_0",   # <-- bbox (1x1x4x8400 grid)
        "/model.22/Sigmoid_output_0", # <-- class score (1x1x80x8400 grid)
        "/model.22/Concat_output_0",  # <-- mask coeff (1x1x32x8400 grid)
